...
Dans l'ensemble elles s’aplatissent précocement, témoignant d’un bon niveau échantillonnage. Les quelques échantillons n'ayant pas attend l'asymptote horizontal ont tout de même était conservé . 
...
\subsection{Résultat descriptif}
...
L'indice de shannon montre que pour un richesse constante dans le temps, l'equitabilité varient. Par exemple la richesse du patient 223 est stable sur le graphique \ref{alphaObs} mais son indice de shannon varie sur le graphique \ref{alphaShannon} témoignant d'une distribution différente. Seul le patient 26 semble conserver à la fois une richesse et une équitabilité stable au court du temps.
...
Le patient 256 présente une dominance à \textit{Sténotrophomonas} sur l'ensemble de ses échantillons. Pour le patient 211, \textit{Achromobacter} est dominant dans le premier échantillon.
...
La figure  \ref{pcoa} montre les échantillons Free et Never sur un graphique d'ordination. Les échantillons Never ont plus de differences entre eux que les échantillons Free qui semble converger.  Les deux groupes sont significativement différent p-value < 0.001.
